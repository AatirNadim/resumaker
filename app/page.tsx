                  ...
                  <li>
                    <div className="grid gap-1">
                      ...
                      <p className="text-muted-foreground">
                        Get personalized recommendations on skills, experience,
                        and more to make your resume stand out.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Pre-Built Templates</h3>
                      <p className="text-muted-foreground">
                        Choose from a variety of professional resume templates
                        to create a polished and visually appealing resume.
                      </p>
                    </div>
                  </li>
                  <li>
                    <div className="grid gap-1">
                      <h3 className="text-xl font-bold">Easy Formatting</h3>
                      <p className="text-muted-foreground">
                        Easily format your resume with our intuitive tools,
                        ensuring a clean and consistent layout.
                      </p>
                    </div>
                  </li>
                </ul>
